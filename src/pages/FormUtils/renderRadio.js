      ...
      return (
        ...
        <React.Fragment key={index}>
          <div className="custom-control custom-radio custom-control-inline">
            ...
            <Field id={`${props.input.name}-${index}`} component="input" name={props.input.name} type="radio" value={key} className="custom-control-input" />
            <Label className="custom-control-label" for={`${props.input.name}-${index}`}>
              {props.options[key]}
            </Label>
          </div>
          &nbsp;
